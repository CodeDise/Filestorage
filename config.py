...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003763877447")) #Your db channel Id
OWNER = os.environ.get("OWNER", "ᴅɪᴀʙʟᴏ") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "6888478102")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8000")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://odb.net/?retryWrites=true&w=majority&appName=Rinfile")
DB_NAME = os.environ.get("DATABASE_NAME", "Rinfile")
#--------------------------------------------
...
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://i.ibb.co/qLyKB4VQ/x.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://i.ibb.co/1JPd18kY/x.jpg")
